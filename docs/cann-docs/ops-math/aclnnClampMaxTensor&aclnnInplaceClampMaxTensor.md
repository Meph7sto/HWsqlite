...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape可以与max进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>，数据类型与clipValueMax的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape可以与self进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>，数据类型与self的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
    ...
    <tr>
      ...
      <td class="tg-0lax">shape需要是self与max <a href="../common/broadcast关系.md" target="_blank">broadcast</a>之后的shape，且数据类型需要是self与max推导之后可转换的数据类型。</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td class="tg-0lax">self与max的shape不满足<a href="../common/broadcast关系.md" target="_blank">broadcast</a>关系，或<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape与输出out的shape不一致。</td>
    </tr>
    <tr>
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape可以与max进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>，数据类型与max的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td class="tg-0pky">FLOAT16、FLOAT、DOUBLE、INT8、UINT8、INT16、INT32、INT64、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">输入</td>
      <td class="tg-0pky">输入tensor，对self的上界进行限制，即公式中的max<sub>i</sub>。</td>
      <td class="tg-0pky">shape可以与selfRef进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>，数据类型与self的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td class="tg-0pky">FLOAT16、FLOAT、DOUBLE、INT8、UINT8、INT16、INT32、INT64、BFLOAT16、BOOL</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
  ...
  - <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、Atlas 350 加速卡
    - selfRef和clipValueMax数据类型需满足数据类型推导规则（参见[TensorScalar互推导关系](../common/TensorScalar互推导关系.md)）。
    - selfRef的数据类型不支持BOOL。
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td class="tg-0lax">selfRef与max的shape不满足<a href="../common/broadcast关系.md" target="_blank">broadcast</a>关系。</td>
    </tr>
    <tr>
