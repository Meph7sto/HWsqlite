...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>公式中的输入self。</td>
      <td>支持空Tensor。<br>数据类型与other的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。<br>shape需要与other满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>公式中的输入other。</td>
      <td>支持空Tensor。<br>数据类型与self的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。<br>shape需要与self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>INT8、UINT8、INT16、INT32、INT64、FLOAT16、FLOAT、DOUBLE、COMPLEX64、COMPLEX128、BFLOAT16</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>公式中的输出out。</td>
      <td>支持空Tensor。<br>数据类型需要是self与other推导之后可转换的数据类型（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。<br>shape需要是self与other broadcast之后的shape。</td>
      <td>INT8、UINT8、INT16、INT32、INT64、FLOAT16、FLOAT、DOUBLE、COMPLEX64、COMPLEX128、BFLOAT16</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
