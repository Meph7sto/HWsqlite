...
```Cpp
aclnnStatus aclnnInplaceFracGetWorkspaceSize(
  aclTensor*      inputRef,
  uint64_t*       workspaceSize,
  aclOpExecutor** executor)
```
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>公式中的input。</td>
      <td>shape需要与out一致。</td>
      <td>FLOAT16、FLOAT、UINT8、INT8、INT16、INT32、INT64、BFLOAT16</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
    </tr>
    <tr>
      ...
      <td>输出</td>
      <td>公式中的out。</td>
      <td>数据类型需要与input一致。shape需要与input一致。</td>
      <td>FLOAT16、FLOAT、UINT8、INT8、INT16、INT32、INT64、BFLOAT16</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
