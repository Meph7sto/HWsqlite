...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>表示待转换的目标张量。</td>
      <td>数据类型与other的数据类型需满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>。shape与other的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td>数据类型是self与other推导之后可转换的数据类型。shape需要与self和other做<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape一致。</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>self和other进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape与out不一样。</td>
    </tr>
  </tbody>
  </table>
