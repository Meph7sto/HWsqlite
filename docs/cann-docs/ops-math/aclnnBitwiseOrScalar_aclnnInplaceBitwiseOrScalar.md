...
- 接口功能：计算输入张量self中每个元素和输入标量other的按位或。输入self和other必须是整数或布尔类型，对于布尔类型，计算逻辑或。
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>数据类型需与self满足<a href="../common/互推导关系.md" target="_blank">互推导关系</a>。</td>
      <td>BOOL、INT8、INT16、UINT16、INT32、INT64、UINT8</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
  ...
  - Atlas 350 加速卡：
    - self和other需满足[TensorScalar互推导关系](../common/TensorScalar互推导关系.md)；
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnBitwiseOrScalarGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>数据类型需与selfRef满足<a href="../common/互推导关系.md" target="_blank">互推导关系</a>。</td>
      <td>BOOL、INT8、INT16、UINT16、INT32、INT64、UINT8</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
  ...
  - Atlas 350 加速卡：selfRef和other需满足[TensorScalar互推导关系](../common/TensorScalar互推导关系.md)，且需要是推导之后可转换的数据类型。
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnInplaceBitwiseOrScalarGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
