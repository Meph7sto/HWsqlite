  ...
  <table style="undefined;table-layout: fixed; width: 1570px"><colgroup>
    ...
    <tbody>
      <tr>
        ...
        <td>输入</td>
        <td>外积扩展矩阵。</td>
        <td>shape维度不能超过2，并且需要与vec1、vec2满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
  ...
  <table style="undefined;table-layout: fixed; width: 1570px"><colgroup>
    ...
    <tbody>
      <tr>
        ...
        <td>输入/输出</td>
        <td>外积扩展矩阵及输出矩阵。</td>
        <td>shape维度为2，不支持空Tensor，并且需要与vec1、vec2满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
        <td>FLOAT、FLOAT16、DOUBLE、INT8、INT16、INT32、INT64、UINT8、BOOL、BFLOAT16</td>
        <td>ND</td>
        <td>-</td>
        <td>√</td>
