...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>公式中的输入self。</td>
      <td>shape需要与out一致，和out的数据类型满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>。</td>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>公式中的out。</td>
      <td>shape需要与self一致，和self的数据类型满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>。</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>self和out的数据类型不满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>。</td>
    </tr>
    <tr>
