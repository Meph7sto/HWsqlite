...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>数据类型需要是self与other推导之后<a href="../common/互转换关系.md" target="_blank">可转换的数据类型</a>。shape需要与self一致。</td>
      <td>DOUBLE、BFLOAT16、FLOAT16、FLOAT32、INT32、INT64、INT8、UINT8</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>out的shape不是self和other <a href="../common/broadcast关系.md" target="_blank">broadcast</a>之后的shape。</td>
    </tr>
  </tbody>
  </table>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td><a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape需要与selfRef的shape一致。</td>
    </tr>
  </tbody>
  </table>
