...
- 接口功能：输入为BOOL型tensor时，进行逻辑非运算；输入为INT型时进行按位非运算。
- 计算公式：
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tbody>
      <tr>
        ...
        <td>公式中的self。</td>
        <td>-</td>
        <td>INT16、INT32、INT64、INT8、UINT8、BOOL</td>
        <td>ND</td>
        <td>-</td>
        <td>√</td>
      </tr>
      <tr>
        ...
        <td>输出</td>
        <td>公式中的out。</td>
        <td>shape与self相同，数据类型需要与self一致。</td>
        <td>INT16、INT32、INT64、INT8、UINT8、BOOL</td>
        <td>ND</td>
        <td>-</td>
        <td>-</td>
  ...
  <col style="width: 833px">
    ...
    <tbody>
      ...
      <tr>
        <td>workspaceSize</td>
        <td>输入</td>
        <td>在Device侧申请的workspace大小，由第一段接口aclnnBitwiseNotGetWorkspaceSize获取。</td>
      </tr>
      <tr>
        <td>executor</td>
        <td>输入</td>
