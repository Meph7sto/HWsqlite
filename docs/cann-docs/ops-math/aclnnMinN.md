...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>需要与out数据类型相同。tensors中各tensor的shape需要与out满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>输出tensor。</td>
      <td>需要与tensors数据类型相同。shape需要与tensors中各tensor的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>FLOAT16、FLOAT、INT8、UINT8、INT32、INT64、BFLOAT16</td>
      <td>ND</td>
      <td>-</td>
      <td>√</td>
