...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用"aclnnAtan2GetWorkspaceSize"或者"aclnnInplaceAtan2GetWorkspaceSize"接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用"aclnnAtan2"或者"aclnnInplaceAtan2"接口执行计算。
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>shape需要与other满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td>shape需要与self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>INT8、INT16、INT32、INT64、UINT8、BOOL、FLOAT、FLOAT16、DOUBLE、BFLOAT16</td>
      <td>ND</td>
      <td>不超过8维</td>
      <td>√</td>
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入/输出</td>
      <td>表示y坐标，与other进行逐元素的反正切运算，计算结果存储在selfRef中。</td>
      <td>shape需要与other满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>INT8、INT16、INT32、INT64、UINT8、BOOL、FLOAT、FLOAT16、DOUBLE、BFLOAT16</td>
      <td>ND</td>
      <td>不超过8维</td>    
    ...
    <tr>
      <td>other（aclTensor*）</td>
      <td>输入</td>
      <td>表示x坐标，与selfRef进行逐元素的反正切运算。</td>
      <td>shape需要与selfRef满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>INT8、INT16、INT32、INT64、UINT8、BOOL、FLOAT、FLOAT16、DOUBLE、BFLOAT16</td>
      <td>ND</td>
      <td>不超过8维</td>
      <td>√</td>
  ...
  - Atlas 350 加速卡：selfRef和other数据类型支持BFLOAT16、FLOAT16、FLOAT32。
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>selfRef和other的shape不能做broadcast。</td>
    </tr>
    <tr>
      <td>selfRef、other的维数大于8。</td>
    </tr>
  </tbody>
  </table>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnInplaceAtan2GetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
