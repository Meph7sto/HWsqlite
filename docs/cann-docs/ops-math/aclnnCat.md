...
- **参数说明**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>需要级联的tensor列表，列表长度不超过32，且数据类型需要列表内部构成满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。</td>
      <td>-</td>
    ...
    <tr>
      <td>out（aclTensor*）</td>
      <td>输出</td>
      <td>输出tensor，且数据类型需要是tensors内部推导之后可转换的类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td>-</td>
      <td>FLOAT、FLOAT16、INT32、INT64、INT16、INT8、UINT8、UINT16、UINT32、UINT64、BOOL、DOUBLE、COMPLEX64、BFLOAT16、HIFLOAT8、FLOAT8_E5M2、FLOAT8_E4M3FN、FLOAT8_E8M0</td>
      <td>ND</td>
      <td>-</td>
