...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnGeTensorGetWorkspaceSize”或者“aclnnInplaceGeTensorGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnGeTensor”或者“aclnnInplaceGeTensor”接口执行计算。
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Tensor类型，数据类型需要与self满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>，shape需要与self的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>DOUBLE、FLOAT16、FLOAT32、INT32、UINT32、INT64、UINT64、INT16、UINT16、INT8、UINT8、BOOL、BFLOAT16</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>out的shape与<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape不一致。</td>
    </tr>
  </tbody>
  </table>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>selfRef和other的数据类型无法进行<a href="../common/互推导关系.md" target="_blank">推导</a>。</td>
    </tr>
    <tr>
      <td>selfRef和other的shape无法做broadcast。</td>
    </tr>
    <tr>
      <td>selfRef和other做<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape不等于selfRef的shape。</td>
    </tr>
    <tr>
...
- Atlas 350 加速卡、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term> aclnnGeTensor示例代码：
...
- Atlas 350 加速卡、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term> aclnnInplaceGeTensor示例代码：
