...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要可以clipValueMin、clipValueMax进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>，数据类型与max的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要可以self、clipValueMax进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>，数据类型与self的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要可以clipValueMin、self进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>，数据类型与self的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td class="tg-0pky">FLOAT16、FLOAT、DOUBLE、INT8、UINT8、INT16、INT32、INT64、BFLOAT16、BOOL</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0lax">shape是self、clipValueMin、clipValueMax进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>的shape，数据类型与self的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
