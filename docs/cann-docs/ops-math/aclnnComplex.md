  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tbody>
      <tr>
        ...
        <td>shape需要与imag满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      ...
      <tr>
        ...
        <td>shape需要与real满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
        <td>FLOAT、FLOAT16、DOUBLE</td>
        <td>ND</td>
        <td>-</td>
        <td>√</td>
