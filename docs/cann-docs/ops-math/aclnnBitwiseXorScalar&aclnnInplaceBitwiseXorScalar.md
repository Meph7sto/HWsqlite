...
- **参数说明：**
  ...
  - Atlas 350 加速卡：selfRef和other数据类型需满足<a href="../common/TensorScalar互推导关系.md" target="_blank">TensorScalar互推导关系</a>，且需要是推导之后可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。
