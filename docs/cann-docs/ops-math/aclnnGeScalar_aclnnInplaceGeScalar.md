...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>数据类型需要与self的数据类型满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>。</td>
      <td>DOUBLE、BFLOAT16、FLOAT16、FLOAT、INT32、UINT32、INT64、UINT64、INT16、UINT16、INT8、UINT8、BOOL</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>数据类型需要是BOOL可转换的数据类型。shape与self相同。</td>
      <td>DOUBLE、BFLOAT16、FLOAT16、FLOAT、INT32、UINT32、INT64、UINT64、INT16、UINT16、INT8、UINT8、BOOL、COMPLEX64、COMPLEX128</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
    </tr>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>selfRef和other的数据类型不满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>。</td>
    </tr>
    <tr>
      <td>selfRef的维度大于8。</td>
    </tr>
...
- Atlas 350 加速卡、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term> aclnnGeScalar示例代码：
...
- Atlas 350 加速卡、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term> aclnnInplaceGeScalar示例代码：
