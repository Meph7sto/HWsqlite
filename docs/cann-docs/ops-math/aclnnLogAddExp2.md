...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">
        <ul>
          <li>数据类型需要可转换成out的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li>
          <li>self与other的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td class="tg-0pky">
        <ul>
          <li>数据类型需要可转换成out的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li>
          <li>other与self的shape满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li>
        </ul>
      </td>
      <td class="tg-0pky">FLOAT16、FLOAT、DOUBLE、UINT8、INT8、UINT16、INT16、UINT32、INT32、UINT64、INT64、BOOL、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
