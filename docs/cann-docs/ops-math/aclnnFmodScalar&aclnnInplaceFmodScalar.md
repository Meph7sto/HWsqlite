...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>待进行Fmod的入参/出参，公式中的self/out。</td>
      <td>-</td>
      <td>DOUBLE、BFLOAT16、FLOAT16、FLOAT32、INT32、INT64、INT8、UINT8</td>
      <td>ND</td>
      <td>0-8</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>selfRef和other不满足<a href="../common/互推导关系.md" target="_blank">数据类型推导规则</a>。</td>
    </tr>
    <tr>
