...
<table style="undefined;table-layout: fixed; width: 1547px"><colgroup>
  ...
  <tbody>
    <tr>
      ...
      <td>数据类型与std的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。shape需要与std满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td>数据类型与mean的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。shape需要与mean满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>BF16、FLOAT16、FLOAT、DOUBLE</td>
      <td>ND</td>
      <td>0-8</td>
      <td>-</td>
