...
- **参数说明**：
  ...
  <tbody>
    <tr>
      ...
      <td>self和exponent数据类型不支持同时为BOOL，shape需要与exponent满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td>self和exponent数据类型不支持同时为BOOL，shape需要与self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>FLOAT、FLOAT16、DOUBLE、INT16、BOOL、INT32、INT64、INT8、UINT8、COMPLEX64、COMPLEX128、BFLOAT16</td>
      <td>ND</td>
      <td>-</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td>数据类型需要是self与exponent推导之后可转换的数据类型（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），shape需要是self与exponent <a href="../common/broadcast关系.md" target="_blank">broadcast</a>之后的shape。</td>
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>数据类型是self与exponent推导之后可转换的数据类型，shape需要与exponent满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>公式中的exponent，pow运算的指数。</td>
      <td>数据类型是self与exponent推导之后可转换的数据类型（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>），shape需要与exponent满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td>FLOAT、FLOAT16、DOUBLE、INT32、INT64、INT8、UINT8、COMPLEX64、COMPLEX128、INT16、BFLOAT16</td>
      <td>ND</td>
      <td>-</td>
      <td>√</td>
