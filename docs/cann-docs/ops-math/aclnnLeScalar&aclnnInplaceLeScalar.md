...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>公式中的other。</td>
      <td>与self满足<a href="../common/互推导关系.md" target="_blank">互推导关系</a>。</td>
      <td>INT8、UINT8、INT16、INT32、INT64、FLOAT16、UINT16、BFLOAT16、FLOAT、DOUBLE、BOOL、UINT64
      </td>
      <td>-</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>公式中的out。</td>
      <td>数据类型需要是BOOL可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。数据shape与self一致。</td>
      <td>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>输入</td>
      <td>公式中的other。</td>
      <td>与selfRef满足<a href="../common/互推导关系.md" target="_blank">互推导关系</a>。</td>
      <td>INT8、UINT8、INT16、INT32、INT64、FLOAT16、UINT16、BFLOAT16、FLOAT、DOUBLE、BOOL、UINT64
      </td>
      <td>-</td>
      <td>-</td>
