...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>self和other的数据类型无法进行<a href="../common/互推导关系.md" target="_blank">推导</a>。</td>
    </tr>
    <tr>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td>selfRef和other的shape无法做<a href="../common/broadcast关系.md" target="_blank">broadcast</a>。</td>
    </tr>
    <tr>
...
- Atlas 350 加速卡、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term> aclnnGtTensor示例代码：
...
- Atlas 350 加速卡、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas 推理系列产品</term>、<term>Atlas 训练系列产品</term> aclnnInplaceGtTensor示例代码：
