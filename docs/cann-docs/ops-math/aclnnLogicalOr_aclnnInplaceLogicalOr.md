...
```Cpp
aclnnStatus aclnnInplaceLogicalOr(
  void*          workspace, 
  uint64_t       workspaceSize, 
  aclOpExecutor* executor, 
  aclrtStream    stream)
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要与other满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、DOUBLE、INT32、INT64、INT16、INT8、UINT8、BOOL、COMPLEX64、COMPLEX128、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">0-8</td>
      <td class="tg-0pky">√</td>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="tg-0pky">输入</td>
      <td class="tg-0pky">要计算或运算的张量。</td>
      <td class="tg-0pky">shape需要与selfRef满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、DOUBLE、INT32、INT64、INT16、INT8、UINT8、BOOL、COMPLEX64、COMPLEX128、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">0-8</td>
      <td class="tg-0pky">√</td>
