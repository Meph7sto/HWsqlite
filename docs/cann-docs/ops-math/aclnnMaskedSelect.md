...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要与mask满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
  ...
  - Atlas 350 加速卡：self和out数据类型支持BFLOAT16、FLOAT16、FLOAT32、DOUBLE、INT8、UINT8、INT16、UINT16、INT32、UINT32、INT64、UINT64、BOOL。
