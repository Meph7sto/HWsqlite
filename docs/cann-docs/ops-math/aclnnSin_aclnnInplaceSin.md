...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>输入tensor。</td>
      <td>shape需要与out一致，和out的数据类型满足数据类型<a href="../common/互推导关系.md" target="_blank">互推导关系</a>。当输入的数据类型为INT8、INT16、INT32、INT64、UINT8、BOOL时，会转换为float数据类型做计算，计算结果转换成out的数据类型。</td>
    ...
    <tr>
      ...
      <td>输出</td>
      <td>输出tensor。</td>
      <td>和self的数据类型满足数据类型<a href="../common/互推导关系.md" target="_blank">互推导关系</a>。</td>
