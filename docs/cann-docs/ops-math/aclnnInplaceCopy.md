...
- **参数说明**：
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">注意目前只有selfRef为连续时，才支持复数间的拷贝，shape需要与src满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
    ...
    <tr>
      ...
      <td class="tg-0lax">注意目前只有selfRef为连续时，才支持复数间的拷贝，shape需要与selfRef满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</td>
