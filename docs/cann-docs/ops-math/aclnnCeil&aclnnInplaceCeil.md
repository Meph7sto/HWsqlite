...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入</td>
      <td>输入tensor，需要向上取整的张量。</td>
      <td>shape和数据类型需要与out一致。</td>
    ...
    <tr>
      <td>out（aclTensor*）</td>
      <td>输出</td>
      <td>输出tensor，存储向上取整的结果。</td>
      <td>shape和数据类型需要与self一致。</td>
      <td>FLOAT16、FLOAT、DOUBLE、BFLOAT16</td>
      <td>ND</td>
      <td>不超过8维</td>
      <td>√</td>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnCeilGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td>输入/输出</td>
      <td>输入输出tensor，需要向上取整的张量，计算结果存储在selfRef中。</td>
      <td>shape和数据类型需要与selfRef一致。</td>
      <td>FLOAT16、FLOAT、DOUBLE、BFLOAT16</td>
      <td>ND</td>
      <td>不超过8维</td>
      <td>√</td>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnInplaceCeilGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
