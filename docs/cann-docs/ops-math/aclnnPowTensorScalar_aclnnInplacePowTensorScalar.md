...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>数据类型不能和self的数据类型同时为BOOL。<br>self和exponent推导后的数据类型为整型时，exponent需要大于等于0。<br>exponent的值需要在self和exponent推导后的数据类型的取值范围内。（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）</td>
      <td>FLOAT、FLOAT16、DOUBLE、INT8、INT16、INT32、INT64、BOOL、UINT8、COMPLEX64、COMPLEX128、BFLOAT16</td>
      <td>-</td>
      <td>-</td>
      <td>-</td>
...
- **参数说明：**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnPowTensorScalarGetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
  ...
  <table style="undefined;table-layout: fixed; width: 1526px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>输入</td>
        <td>公式中的输入exponent</td>
        <td>selfRef和exponent推导后的数据类型为整型时，exponent需要大于等于0。<br>exponent的值需要在selfRef和exponent推导后的数据类型的取值范围内。（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）</td>
        <td>FLOAT、FLOAT16、DOUBLE、INT32、INT64、INT8、UINT8、COMPLEX64、COMPLEX128、INT16、BFLOAT16</td>
        <td>ND</td>
        <td>0-8</td>
        <td>-</td>
  ...
  <table style="undefined;table-layout: fixed; width: 1149px"><colgroup>
    ...
    <tbody>
      ...
      <tr>
        <td>workspaceSize</td>
        <td>输入</td>
        <td>在Device侧申请的workspace大小，由第一段接口aclnnInplacePowTensorScalarGetWorkspaceSize获取。</td>
      </tr>
      <tr>
        <td>executor</td>
        <td>输入</td>
