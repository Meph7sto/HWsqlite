...
注意，该基础数据结构可通过[《算子库》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/aolapi/operatorlist_00001.html)中“公共接口”创建，如aclCreateTensor等。
