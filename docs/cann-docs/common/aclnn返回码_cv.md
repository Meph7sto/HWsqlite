...
对于异常状态码值，可以通过aclGetRecentErrMsg接口（参见[《Runtime运行时 API》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/runtimeapi/aclcppdevg_03_0019.html)）获取异常信息，您可以根据报错提示排查问题或者联系技术支持。
