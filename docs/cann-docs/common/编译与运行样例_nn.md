...
- 算子API的调用流程和编译运行操作详情请参见[《应用开发（C&C++）》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/programug/acldevg/aclcppdevg_000006.html)中“单算子调用>单算子API执行>调用aclnn接口示例代码”。
...
- **示例代码**
   ...
   已知AddMatMul算子实现了张量加法运算，计算公式为：out = β  self + α  (mat1 @ mat2)。您可以从[aclnnAddmm&aclnnInplaceAddmm.md](../ops-nn/aclnnAddmm&aclnnInplaceAddmm.md)中“调用示例”获取示例代码，并将代码文件命名为“**test\_addmm.cpp**”。
