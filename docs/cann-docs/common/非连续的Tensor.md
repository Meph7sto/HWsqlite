...
说明：创建aclTensor可通过[《算子库》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/aolapi/operatorlist_00001.html)中“公共接口>aclCreateTensor”实现。
