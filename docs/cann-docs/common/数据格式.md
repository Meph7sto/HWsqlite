...
关于aclTensor支持的**全量数据格式范围**参见[《Runtime运行时 API》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/runtimeapi/aclcppdevg_03_0019.html)中“数据类型及其操作接口>aclFormat”。

关于**数据格式排布原理**介绍参见[《Ascend C算子开发指南》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/programug/Ascendcopdevg/atlas_ascendc_map_10_0002.html)中“概念原理和术语>神经网络和算子>数据排布格式”。
