...
通过**aclCreateTensor**接口创建aclTensor时，支持的全量数据类型参见[《Runtime运行时 API》](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/runtimeapi/aclcppdevg_03_0019.html)中“数据类型及其操作接口>aclDataType”。
