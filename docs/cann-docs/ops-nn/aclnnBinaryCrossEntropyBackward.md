...
- **参数说明：**
  ...
  <tbody>
      ...
      <td>输入</td>
      <td>结果的权重。</td>
      <td><ul><li>shape可以<a href="../common/broadcast关系.md" target="_blank">broadcast</a>到self的shape。</li><li>当weightOptional为空时，需要以self的shape创建一个全1的Tensor。</li></ul></td>
      <td>FLOAT、FLOAT16、BFLOAT16</td>
      <td>需要与self保持一致。</td>
      <td>0-8</td>
      <td>√</td>
...
- **返回值**
  ...
  第一段接口完成入参校验，出现以下场景时报错：
    ...
    <tbody>
      ...
      <tr>
      <td>gradOutput、target和weightOptional的shape不能<a href="../common/broadcast关系.md" target="_blank">broadcast</a>到self的shape。</td>
      </tr>
      <tr>
