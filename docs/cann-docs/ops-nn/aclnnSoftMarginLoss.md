...
- **参数说明**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要与target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型需满足与target数据类型推导规则。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型需满足与self数据类型推导规则。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0lax">若reduction取值为'none'，则shape需要与self和target进行<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape一致，否则out为scalar。</td>
...
- **返回值**：
  ...
  <tbody>
    ...
    <tr>
      <td class="tg-0pky">self和target的shape不满足<a href="../common/broadcast关系.md" target="_blank">broadcast</a>规则，或者<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape与out不一致。</td>
    </tr>
  </tbody>
  </table>
