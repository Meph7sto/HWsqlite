...
- **参数说明：**
  ...
  <tbody>
     ...
     <tr>
      ...
      <td>输出</td>
      <td>表示计算输出。</td>
      <td><ul><li>不需要额外申请空间，数据类型需要是gradOutput与self推导之后可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li><li>其他数据类型（INT8、UINT8、INT16、UINT16、INT32、UINT32、INT64、UINT64、BOOL、COMPLEX64、COMPLEX128）通过自动cast能力支持，但会额外申请空间。</li></ul></td>
      <td>FLOAT、FLOAT16、BFLOAT16、DOUBLE</td>
      <td>ND</td>
      <td>0-8</td>
      <td>√</td>
