...
- 确定性说明：
  ...
  - <term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>、<term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、Atlas 350 加速卡：aclnnConvertWeightToINT4Pack默认确定性实现。
...
- Atlas 350 加速卡：
  ...
  示例代码如下（INT32输入），仅供参考，具体编译和执行过程请参考[编译与运行样例](../common/编译与运行样例_nn.md)。
  伪量化有aclnnWeightQuantBatchMatmulV2和aclnnWeightQuantBatchMatmulV3接口， 这里以aclnnWeightQuantBatchMatmulV2为例
...
- Atlas 350 加速卡：
  示例代码如下（FLOAT输入），仅供参考，具体编译和执行过程请参考[编译与运行样例](../common/编译与运行样例_nn.md)。
  伪量化有aclnnWeightQuantBatchMatmulV2和aclnnWeightQuantBatchMatmulV3接口， 这里以aclnnWeightQuantBatchMatmulV2为例
