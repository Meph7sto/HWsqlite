...
- 接口功能：均方误差函数[aclnnMseLoss](./aclnnMseLoss.md)的反向传播。
...
- **参数说明**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要与self和target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br></td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与gradOutput、target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br></td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与gradOutput、self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br></td>
      <td class="tg-0pky">与self保持一致。</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">out与gradOutput、self、target <a href="../common/broadcast关系.md" target="_blank">broadcast</a>之后的tensor的shape一致。<br>数据类型时self可推导的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
...
- **返回值：**
  ...
  <tbody>
    ...
    <tr>
      <td class="tg-0pky">gradOutput、self和target做<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape与out的shape不一致。</td>
    </tr>
    <tr>
