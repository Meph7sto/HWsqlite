...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>shape需要与output满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li></ul></td>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>shape需要与gradOutput满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li></ul></td>
      <td>FLOAT、FLOAT16、BFLOAT16、DOUBLE、COMPLEX64、COMPLEX128</td>
      <td>ND</td>
      <td>1-8</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>shape需要与gradOutput，output满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。</li><li>数据类型需要是gradOutput，output可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</li></ul></td>
      <td>FLOAT、FLOAT16、BFLOAT16、DOUBLE、COMPLEX64、COMPLEX128</td>
      <td>ND</td>
      <td>1-8</td>
      <td>√</td>
