...
## 功能说明
  ...
  计算[aclnnL1Loss](./aclnnL1Loss.md)的反向传播。reduction指定损失函数的计算方式，支持 'none'、'mean'、'sum'。'none' 表示不应用减少，'mean' 表示输出的总和将除以输出中的元素数，'sum' 表示输出将被求和。
...
- **参数说明**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要与self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与self、target的数据类型满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与gradOutput、target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与gradOutput、target满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与gradOutput、self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型要与self、gradOutput满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">数据类型要与self满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
...
- **返回值：**
  ...
  第一段接口完成入参校验，出现以下场景时报错：
    ...
    <tbody>
      ...
      <tr>
        <td class="tg-0pky">gradOutput、self和target的shape无法做<a href="../common/broadcast关系.md" target="_blank">broadcast</a>。</td>
      </tr>
      <tr>
        <td class="tg-0pky">gradOutput、self和target的shape超过8维。</td>
      </tr>
      <tr>
        <td class="tg-0lax">gradOutput、self和target做<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape与gradInput不一致。</td>
      </tr>
      <tr>
