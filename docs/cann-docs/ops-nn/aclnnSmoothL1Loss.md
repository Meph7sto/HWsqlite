...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要与target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型需满足与target数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型需满足与self数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND、NCL、NCHW、NHWC</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0lax">当reduction为none时，shape与self和target的<a href="../common/broadcast关系.md" target="_blank">broadcast</a>结果一致，当reduction为mean或sum时为[1]，数据类型为self和target推导后可转换的数据类型（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）</td>
