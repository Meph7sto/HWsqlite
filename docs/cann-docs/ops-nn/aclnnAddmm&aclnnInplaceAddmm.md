...
- **参数说明**
  ...
  <tbody>
    <tr>
      ...
      <td>数据类型需要与mat1@mat2满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</td>
      <td rowspan="2">BFLOAT16、FLOAT16、FLOAT32</td>
      <td rowspan="2">ND</td>
      <td rowspan="2">1~2</td>
      <td rowspan="2">√</td>
    </tr>
    <tr><td>需要与mat1@mat2满足<a href="../common/broadcast关系.md">broadcast关系</a>。</td></tr>
    <tr>
      ...
      <tr><td>需要与self、mat2满足<a href="../common/broadcast关系.md">broadcast关系</a>。</td></tr>
    ...
    <tr>
      ...
      <td>数据类型需要与mat1满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</td>
      ...
      <tr><td>需要与self、mat1满足<a href="../common/broadcast关系.md">broadcast关系</a>。</td></tr>
...
- 确定性说明：
  ...
  - Atlas 350 加速卡: aclnnAddmm&aclnnInplaceAddmm默认确定性实现。
