...
- 接口功能：计算[aclnnSmoothL1Loss](./aclnnSmoothL1Loss.md) api的反向传播。
- 计算公式：
...
- **参数说明**
  ...
  <tbody>
    <tr>
      ...
      <td class="tg-0pky">shape需要与self和target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与self、target的数据类型需满足数据类型推导规则。</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与gradOutput、target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与gradOutput、target的数据类型需满足数据类型推导规则。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
    ...
    <tr>
      ...
      <td class="tg-0pky">shape需要与gradOutput、self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与gradOutput、target的数据类型需满足数据类型推导规则。</td>
      <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
      <td class="tg-0pky">ND</td>
      <td class="tg-0pky">1-8</td>
      <td class="tg-0pky">√</td>
