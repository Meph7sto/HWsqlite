...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用“aclnnFusedMatmulGetWorkspaceSize”接口获取计算所需workspace大小以及包含了算子计算流程的执行器，再调用“aclnnFusedMatmul”接口执行计算。
  ...
  <table style="undefined;table-layout: fixed; width: 1550px"><colgroup>
    ...
    <tbody>
      <tr>
        ...
        <td><li>数据类型需要与x2满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。</li></td>
      ...
      <tr>
        ...
        <td><li>数据类型需要与x1满足数据类型推导规则（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。</li></td>
        <td>数据类型与x1保持一致</td>
        <td>ND</td>
        <td>2</td>
        <td>√</td>
      ...
      <tr>
        ...
        <td><li>数据类型需要与x1和x2推导后的数据类型一致（参见<a href="../common/互推导关系.md" target="_blank">互推导关系</a>）。</li></td>
        <td>FLOAT16、BFLOAT16、FLOAT32</td>
        <td>ND</td>
        <td>2</td>
        <td>√</td>
