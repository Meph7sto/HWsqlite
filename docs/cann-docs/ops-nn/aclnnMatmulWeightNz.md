...
- 确定性说明：
  - <term>Atlas 训练系列产品</term>、<term>Atlas 推理系列产品</term>、Atlas 350 加速卡：aclnnMatmulWeightNz默认确定性实现。
...
- Atlas 350 加速卡：
  self和mat2数据类型为bfloat16，mat2为NZ格式场景下的示例代码如下，仅供参考，具体编译和执行过程请参考[编译与运行样例](../common/编译与运行样例_nn.md)。
