...
每个算子分为[两段式接口](../common/两段式接口.md)，必须先调用 “aclnnAddmmWeightNzGetWorkspaceSize” 接口获取入参并根据计算流程计算所需workspace大小，再调用 “aclnnAddmmWeightNz”接口执行计算。
...
- **参数说明**
  ...
  <tbody>
    <tr>
      ...
      <li>需要与mat1@mat2满足<a href="../common/broadcast关系.md">broadcast关系</a>。</li> <li> self支持shape为（n），（1，n），（m，n）。</li> </ul></td>
    ...
    <tr>
      ...
      <td><ul><li>数据类型需要与mat1满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</li><li>mat2的Reduce维度需要与mat1的Reduce维度大小相等。</li><li>需要与self、mat1满足<a href="../common/broadcast关系.md">broadcast关系</a>。</li> 
