...
- **参数说明：**
  ...
  <table style="undefined;table-layout: fixed; width: 1567px"><colgroup>
    ...
    <tr>
     ...
     <td>
       <ul><li>支持空Tensor。</li><li>shape为(N,C<sub>out</sub>,H<sub>out</sub>)。</li><li>数据类型与 weight 的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>）。</li></ul>
     </td>
    ...
    <tr>
     ...
     <td>
       <ul>
        ...
        <li>数据类型与 weight 的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>)。</li></ul>
     </td>
     <td>FLOAT、FLOAT16、BFLOAT16</td>
     <td>ND、NCL</td>
     <td>3</td>
    ...
    <tr>
     ...
     <td>
       <ul>
        ...
        <li>数据类型与 input、self 的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>)。</li>
      </ul>
     </td>
     <td>FLOAT、FLOAT16、BFLOAT16</td>
     <td>ND、NCL</td>
