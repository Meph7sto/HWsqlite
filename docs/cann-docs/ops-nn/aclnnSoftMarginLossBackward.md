...
计算[aclnnSoftMarginLoss](./aclnnSoftMarginLoss.md)二分类逻辑损失函数的反向传播。reduction指定损失函数的计算方式，支持 'none'、'mean'、'sum'。'none' 表示不应用reduction，'mean' 表示输出的总和将除以输出中的元素数，'sum' 表示输出将被求和。
...
- **参数说明**
    ...
    <tbody>
      <tr>
        ...
        <td class="tg-0pky">shape需要与self和target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与self、target的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
      ...
      <tr>
        ...
        <td class="tg-0pky">shape需要与gradOutput、target满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与gradOutput、target的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
        <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
        <td class="tg-0pky">ND</td>
        <td class="tg-0pky">1-8</td>
        <td class="tg-0pky">√</td>
      ...
      <tr>
        ...
        <td class="tg-0pky">shape需要与gradOutput、self满足<a href="../common/broadcast关系.md" target="_blank">broadcast关系</a>。<br>数据类型与gradOutput、target的数据类型需满足数据类型推导规则（参见<a href="../common/互转换关系.md" target="_blank">互转换关系</a>）。</td>
        <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
        <td class="tg-0pky">ND</td>
        <td class="tg-0pky">1-8</td>
        <td class="tg-0pky">√</td>
      ...
      <tr>
        ...
        <td class="tg-0pky">shape为gradOutput，self，target的<a href="../common/broadcast关系.md" target="_blank">broadcast</a>结果。</td>
        <td class="tg-0pky">FLOAT、FLOAT16、BFLOAT16</td>
        <td class="tg-0pky">ND</td>
        <td class="tg-0pky">1-8</td>
        <td class="tg-0pky">√</td>
...
- **返回值**：
  ...
  <col style="width: 746px">
    ...
    <tbody>
      ...
      <tr>
        <td class="tg-0lax">gradOutput、self和target、out的shape不满足<a href="../common/broadcast关系.md" target="_blank">broadcast</a>规则。</td>
      </tr>
      <tr>
        <td class="tg-0pky">gradOutput、self和target做<a href="../common/broadcast关系.md" target="_blank">broadcast</a>后的shape与out不一致。</td>
      </tr>
    </tbody>
    </table>
