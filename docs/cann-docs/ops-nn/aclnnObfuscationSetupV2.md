      ...
      <tr>
        ...
        <td>
          <ul>
            ...
            <li><term>Atlas A2 训练系列产品/Atlas A2 推理系列产品</term>：在{0, 1, 2, 27}中选择，0表示FLOAT、1表示FLOAT16、2表示INT8、27表示BF16。</li>
          </ul>
        </td>
        <td>INT32</td>
        <td>-</td>
...
- **返回值**
  ...
  aclnnStatus：返回状态码，具体参见[aclnn返回码](../common/aclnn返回码_ras.md)。
...
- **返回值**
    ...
    返回aclnnStatus状态码，具体参见[aclnn返回码](../common/aclnn返回码_ras.md)。
...
示例代码如下，仅供参考，具体编译和执行过程请参考[编译与运行样例](../common/编译与运行样例_ras.md)。
