...
- **参数说明：**
  ...
  <tbody>
    <tr>
      ...
      <td><ul>
      <li>数据类型与batch1@batch2的数据类型需满足数据类型推导规则（参见<a href="../common/互推导关系.md">互推导关系</a>和<a href="#约束说明">约束说明</a>）。</li><li>shape需要与batch1@batch2的后两维的shape一致。</li>
      <li>支持空Tensor。</li></ul></td>
      <td>BFLOAT16、FLOAT16、FLOAT32</td>
      <td>ND</td>
      <td>2</td>
...
- 确定性说明：
  ...
  - Atlas 350 加速卡：aclnnAddbmm&aclnnInplaceAddbmm默认确定性实现。
