...
说明：本示例代码调用了部分HCCL集合通信库接口：HcclCommInitClusterInfoConfig、HcclGetCommName、HcclCommDestroy, 请参考[<<HCCL集合通信库>API>>](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/hcclug/hcclcpp_07_0003.html)。
