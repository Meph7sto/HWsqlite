...
- shape 格式字段含义说明
  ...
  | He           | Head-Size（隐藏层大小）        | A2、A3、Atlas 350 加速卡取值固定为：1024、2048、3072、4096、5120、6144、7168、7680、8192  |
...
- aclnnMlaPrologV3WeightNz接口支持场景：A2、A3当前不支持fp8/hif8/mxfp8全量化场景，Atlas 350 加速卡当前支持所有量化场景
