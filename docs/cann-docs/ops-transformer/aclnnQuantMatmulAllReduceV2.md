...
- **接口功能**：`aclnnQuantMatmulAllReduceV2`接口是对`aclnnQuantMatmulAllReduce`接口的功能扩展，新增支持pertoken量化方式。`aclnnQuantMatmulAllReduceV2`共支持pertensor、perchannel、pertoken[量化方式](../common/量化介绍.md)。
...
- 确定性计算：
  ...
  - Atlas 350 加速卡：`aclnnQuantMatmulAllReduceV2`默认确定性实现。
