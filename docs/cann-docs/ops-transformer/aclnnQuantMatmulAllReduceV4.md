...
- **接口功能**：兼容`aclnnQuantMatmulAllReduce`、`aclnnQuantMatmulAllReduceV2`、`aclnnQuantMatmulAllReduceV3`支持的功能。
  ...
  - Atlas 350 加速卡：新增perblock、pertile、mxfp量化方式。新增x1，x2输入支持dtype为`FLOAT8_E4M3FN`、`FLOAT8_E5M2`、HIFLOAT8、`FLOAT4_E2M1`。
- **计算公式**：
...
- 确定性计算：
  ...
  - Atlas 350 加速卡：`aclnnQuantMatmulAllReduceV4`默认确定性实现。
