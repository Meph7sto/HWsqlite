...
- **参数说明：**
    ...
    <tr>
        ...
        <td>输入</td>
        <td>即计算公式中的x2。</td>
        <td><ul><li>支持空Tensor。</li><li>与x1的数据类型保持一致。</li><li>当前版本仅支持二维输入，支持转置/不转置场景。</li><li>仅支持两根轴转置情况下的非连续Tensor，其他场景的<a href="../common/非连续的Tensor.md">[非连续的Tensor]</a>不支持。</li></ul></td>
        <td>FLOAT16、BFLOAT16</td>
        <td>ND</td>
        <td>2</td>
        <td>√（仅适用转置场景）</td>
