  ...
  <tbody>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        ...
        <li>cacheMode为2：shape为[tokenNum, headNum, 512]，dtype为INT8，<a href="../common/数据格式.md">数据格式</a>为ND格式。</li></ul>
      </td>
      <td>INT8、FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        ...
        <li>cacheMode为2：shape为[blockNum, 16, blockSize, 32]，dtype为INT8，<a href="../common/数据格式.md">数据格式</a>为NZ。</li>
        <li>cacheMode为3：shape为[blockNum, 32, blockSize, 16]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为NZ。</li></ul>
      </td>
      <td>INT8、FLOAT16、BFLOAT16</td>
      <td>ND、NZ</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        ...
        <li>cacheMode为2：shape为[tokenNum, headNum, 64]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为ND。</li></ul>
      </td>
      <td>FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>-</td>
    ...
    <tr>
      ...
      <td>shape和dtype随cacheMode变化：<ul>
        ...
        <li>cacheMode为2或3：shape为[blockNum, 4 ,blockSize, 16]，dtype与input一致，<a href="../common/数据格式.md">数据格式</a>为NZ。</li></ul>
      </td>
      <td>FLOAT16、BFLOAT16</td>
      <td>ND、NZ</td>
      <td>-</td>
