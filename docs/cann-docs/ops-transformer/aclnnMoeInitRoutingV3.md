...
- 接口功能：MoE的routing计算，根据[aclnnMoeGatingTopKSoftmaxV2](./aclnnMoeGatingTopKSoftmaxV2.md)的计算结果做routing处理，支持不量化、静态量化和动态量化模式。本接口针对V2接口[aclnnMoeInitRoutingV2](./aclnnMoeInitRoutingV2.md)做出如下功能变更，请根据实际情况选择合适的接口：<br>
...
- **不同产品支持情况差异**
  - quantMode支持情况差异：
    ...
    - Atlas 350 加速卡：支持-1、0、1、2、3、6、7、8。
