...
- **参数说明**
    ...
    <tr>
        ...
        <td>输入</td>
        <td>ep通信域的大小。</td>
        <td><br><term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>支持8、16、32、64、128；<br>Atlas 350 加速卡支持2、4、8、16、32、64。</td>
        <td>INT64</td>
        <td>-</td>
        <td>-</td>
        <td>-</td>
...
- 本示例代码调用了部分HCCL集合通信库接口：HcclGetCommName、HcclCommInitAll、HcclCommDestroy, 请参考[<<HCCL集合通信库>API>>](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/910beta1/API/hcclug/hcclcpp_07_0003.html)。
