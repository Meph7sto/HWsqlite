...
- 接口功能：
    - 完成量化的路由专家GroupedMatMul、Unpermute、AlltoAllv融合并实现与共享专家MatMul并行融合，先计算后通信，支持Pertensor-Pertensor、Mx[量化模式](../common/量化介绍.md)。
...
- **参数说明**
  ...
  gmmXQuantMode、gmmWeightQuantMode、mmXQuantMode、mmWeightQuantMode、commQuantMode的枚举值跟[量化模式](../common/量化介绍.md)关系如下:
  * 0: 非量化
  * 1: pertensor
  * 2: perchannel
  * 3: pertoken
